    ...
    if(isset($_POST['btnSend']))
    {
        ...
        if($err!=""){
            echo $err;
                ...
                $sq = "SELECT * FROM public.feedback where username='$us' and email = '$email' and description='$sub'";
				$result = pg_query($conn, $sq);
				if(pg_num_rows($result)==0){
					pg_query($conn, "INSERT INTO public.feedback (username, email, description) VALUES ('$us', '$email', '$sub')");
